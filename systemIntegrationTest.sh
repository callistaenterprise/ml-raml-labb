...
studyId=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/studies \
  -X POST -d '{"name":"S-1","description":"descr","startdate":"2015-08-06","enddate":"2016-08-06"}' | jq -r .id`
...
doctor1Id=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/doctors \
...
curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/studies/$studyId/assignedDoctors -X POST -d "{\"id\":\"$doctor1Id\"}"


# 2.3 Check studies that doctor #1 is assigned to

doctor1AssignedStudies=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/doctors/$doctor1Id/assignedInStudies | jq -r '.[] | .id'`
...
doctor2Id=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/doctors \
...
curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/studies/$studyId/assignedDoctors -X POST -d "{\"id\":\"$doctor2Id\"}"


# 2.6 Check studies that doctor #2 is assigned to

doctor2AssignedStudies=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/doctors/$doctor2Id/assignedInStudies | jq -r '.[] | .id'`
...
doctorsAssignedInStudy=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/studies/$studyId/assignedDoctors`
...
patient1Id=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients \
...
curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/doctors/$doctor1Id/assignedInStudies/$studyId/patients -X POST -d "{\"id\":\"$patient1Id\"}"


# 3.3 Register patient #2

patient2Id=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients \
...
curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/doctors/$doctor1Id/assignedInStudies/$studyId/patients -X POST -d "{\"id\":\"$patient2Id\"}"


# 3.5 Check assigned patients to the study by doctor #1

doctor1Patients=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/doctors/$doctor1Id/assignedInStudies/$studyId/patients`
...
availableStudies=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/studies | jq .`
...
patient1ByUsername=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients?username=P-1 | jq -r '.[] | .id'`
...
patient1Study=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients/$patient1Id/studies | jq -r '.[] | .id'`
...
patient1measurement1=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients/$patient1Id/studies/$patient1Study/measurements \
  -X POST -d '{"description":"descr","timestamp":"2015-08-08T14:23:46Z","steps":1000}'`
echo patient1measurement1: $patient1measurement1

patient1measurement2=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients/$patient1Id/studies/$patient1Study/measurements \
...
patient1measurements=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients/$patient1Id/studies/$patient1Study/measurements | jq .`
...
patient2ByUsername=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients?username=P-2 | jq -r '.[] | .id'`
...
patient2Study=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients/$patient2Id/studies | jq -r '.[] | .id'`
...
patient2measurement1=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients/$patient2Id/studies/$patient2Study/measurements \
  -X POST -d '{"description":"descr","timestamp":"2015-08-04T09:12:05Z","steps":3000}'`
echo patient2measurement1: $patient2measurement1

patient2measurement2=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients/$patient2Id/studies/$patient2Study/measurements \
...
patient2measurements=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/patients/$patient2Id/studies/$patient2Study/measurements | jq .`
...
studyMeasurements=`curl $hdr -H "Content-Type: application/json" http://$host:$port/$baseUri/studies/$studyId/measurements | jq .`
